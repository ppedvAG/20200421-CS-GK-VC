...
namespace DataTypesLib
{
    public static class MyDouble
    {
        ...
        public static void ZeigeDouble()
        {
            ...
            Console.WriteLine($"double.Parse(myDblAsStr1): {double.Parse(myDblAsStr1, System.Globalization.CultureInfo.InvariantCulture)}, double.Parse(myDblAsStr2): {double.Parse(myDblAsStr2, System.Globalization.CultureInfo.InvariantCulture)}");
        }
    }
}
